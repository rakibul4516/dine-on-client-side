            ...
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/1T2SXYv/2546332495.jpg)' }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-6xl font-bold font-[Montez]">For your special day</h1>
                        <h1 className="mb-5 text-2xl font-semibold font-[Suranna]">EXCEPTIONAL CATERING SERVICES</h1>
