        ...
        <div className="w-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div className="flex items-center justify-between px-2 py-2">
                <div className="flex items-center">
                    <FcGlobe className=' text-lg font-semibold'></FcGlobe>
                    <h1 className="mx-2 text-lg font-semibold text-slate-700">{origin}</h1>
                </div>
                <div className="flex">
                    <h1 className="mx-3 text-xl font-semibold text-slate-700">$ {price}</h1>
                </div>
            </div>
